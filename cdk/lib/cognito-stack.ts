import { Stack, StackProps, RemovalPolicy, Duration, SecretValue, CfnOutput } from 'aws-cdk-lib';
...
export class CognitoStack extends Stack {
  ...
  constructor(scope: Construct, id: string, props: CognitoStackProps = {}) {
    ...
    const googleProvider = new cognito.UserPoolIdentityProviderGoogle(this, 'GoogleProvider', {
      userPool,
      clientId:
        props.googleClientId || process.env.GOOGLE_CLIENT_ID || 'placeholder-google-client-id',
    ...
    const userPoolClient = new cognito.UserPoolClient(this, 'UserPoolClient', {
      ...
      oAuth: {
        ...
        logoutUrls: [`https://${domainName}`, `https://www.${domainName}`, 'http://localhost:3000']
      },
    ...
    authenticatedRole.addToPolicy(
      new iam.PolicyStatement({
        ...
        resources: [`arn:aws:dynamodb:${this.region}:${this.account}:table/lightningtalk-*`]
      })
    );

...
export const getComponentSpacing = (component: ComponentSpacing, size?: string): string => {
  ...
  if (typeof componentSpacing === 'object' && size) {
    return (componentSpacing as any)[size] || componentSpacing.md || Object.values(componentSpacing)[0];
  }
  return '1rem';
};

// Responsive spacing helper
export const getResponsiveSpacing = (type: ResponsiveSpacing, breakpoint: 'mobile' | 'tablet' | 'desktop' = 'mobile'): string => {

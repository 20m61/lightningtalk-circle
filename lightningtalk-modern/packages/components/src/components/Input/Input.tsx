...
const Input = forwardRef<HTMLInputElement, InputProps>(
  (
    ...
    const baseInputStyles: React.CSSProperties = {
      ...
      // Placeholder styles handled via CSS modules
    ...
    return (
      <div className={clsx('lt-input-container', containerClassName)} style={containerStyles}>
        {/* Label */}
        {label && (
          <label className="lt-input__label" style={labelStyles}>
            {label}
        ...
        {/* Input wrapper */}
        <div className="lt-input__wrapper" style={inputWrapperStyles}>
          {/* Start icon */}
          {startIcon && (
            <div className="lt-input__start-icon" style={startIconStyles}>
              {startIcon}
            </div>
          )}
          ...
          {loading ? (
            ...
            <div className="lt-input__end-icon" style={endIconStyles}>
              {endIcon}
            </div>
          ) : null}
        </div>
        ...
        {(helperText || error || showCharCount) && (
          <div className="lt-input__helper-text" style={helperTextStyles}>

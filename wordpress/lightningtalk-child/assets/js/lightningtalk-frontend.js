...
(function($) {
    ...
    window.LightningTalk = {
        ...
        showRegistrationModal: function(eventId) {
            const modalHtml = `
        ...
        updateSurveyCount: function(type) {
            const storageKey = 'lightningtalk_survey_count_' + LightningTalk.config.eventId;
            let counts = JSON.parse(localStorage.getItem(storageKey) || '{"survey-online": 0, "survey-offline": 0}');
        ...
        saveChatMessage: function(message, timestamp) {
